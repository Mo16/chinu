! function(e) {
    ...
    var h = function() {
        ...
        return e = i, (t = [{
            key: "init",
            value: function() {
                a(l(i.prototype), "init", this).call(this), this.countDownDate = new Date("01/22/2022 16:00:00 GMT+00:00"), this.initCountDown();
                var e = (o.a.isDesktop, {
                        x: "2rem",
                        y: "2rem"
                    }),
    ...
    */
    ...
    var h = function() {
        function e() {
            ! function(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, e), console.log("Start WebSite"), window.main = this, gsap.defaults({
                overwrite: "auto"
